...
(function () {
  ...
  jQuery.fn.extend({
    imagepicker: function imagepicker(e) {
    ...
    return t.prototype.destroy = function () {
      ...
      var t, e;
      return this.node = jQuery("<li/>"), t = jQuery("<img class='image_picker_image'/>"), t.attr("src", this.option.data("img-src")), e = jQuery("<div class='thumbnail'>"), e.click({
        option: this
      }, function (t) {
